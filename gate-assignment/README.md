...
Your task is to build a system that assigns gates over time, avoiding conflicts and adapting to changing information — the core decision logic of a simplified Gate Management System, the kind that sits at the heart of real airport operations software.
